...
export default function Contact() {
  return (
    <section id="contact" className="flex flex-col md:flex-row items-center md:items-start md:mb-20 px-4 justify-center gap-4 lg:gap-24 scroll-mt-20 xl:scroll-mt-45">
      <div className="flex flex-col items-center max-w-xs lg:max-w-lg gap-5 px-4 md:pt-10">
