  ...
  return (
    <div className="flex flex-col items-start justify-center gap-4 p-4 border border-primary rounded-md font-oswald text-white text-lg w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <a href="https://www.google.com/maps/dir//3801+Victory+Blvd+Suite+G+Staten+Island,+NY+10314/@40.5973185,-74.1828036,16z/data=!4m5!4m4!1m0!1m2!1m1!1s0x89c24c9029eaaaab:0x9bf868165dc96954">
