...
export const coaches: coach[] = [
  {
    name: "Johnny Pierro",
    image: { path: "/headshots/mma-staten-island.png", height: 875, width: 543 },
  ...
  {
    name: "Craig Sampson",
    image: { path: "/headshots/bjj-staten-island.webp", height: 4040, width: 2496 },
  ...
  {
    name: "Mike Carim",
    image: { path: "/headshots/staten-island-jiu-jitsu.webp", height: 4897, width: 2713 },
  ...
  {
    name: "Vin Pagnotta",
    image: { path: "/headshots/staten-island-bjj.webp", height: 4032, width: 3024 },
  ...
  {
    name: "Nick Volpe",
    image: { path: "/headshots/staten-island-mma.webp", height: 1206, width: 797 },
    title: "Brazilian Jiu Jitsu Coach",
    classes: ["BJJ"],
    logo: { path: "/headshots/dark-bear-bjj.webp", height: 2304, width: 4608 },
