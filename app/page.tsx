...
export default function Home() {
  return (
    ...
    <div className="space-y-1">
      ...
      <h4>World class coaching in MMA, Brazilian Jiu Jitsu, Wrestling, Kickboxing and more...</h4>
      <p>Blend striking, grappling, and strategy into one complete combat sport. Train to compete or simply push yourself beyond limits.</p>
    </div>
  );
}
